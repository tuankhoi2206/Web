(function () {
  ...
  angular.module('songApp')
    .controller('SongCtrl', ['$location', 'SongFactory', 'CommonService', 'commonConstant','$q',
      function ($location, SongFactory, CommonService, commonConstant,$q) {
        ...
        function init() {
          ...
          vm.configDataSongTable = {
            ...
            listCheckedChkBox: vm.cache.showSongsView.listCheckedChkBox, // list
																			// checkbox
																			// is
																			// check
        ...
        var deferred = $q.defer();
          /*
            * inject :response else everything header...
           */
        ...
        function removeSongs() {
          if (vm.showSongsView.isCheckedHeaderChkbox.status) {
            ...
            vm.showSongsView.isCheckedHeaderChkbox.status = false;// reset
																	// checkbox
																	// model
